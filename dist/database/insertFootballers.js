...
export const insertFootballers = async () => {
    try {
        const rawData = fs.existsSync(RAW_BOOTSTRAP_STATIC_FILE)
        ...
        for (const footballer of rawData.elements) {
            const footballerObject = {
                ...
                expected_goal_involvements_per_90: footballer.expected_goal_involvements_per_90,
                expected_goals_conceded_per_90: footballer.expected_goals_conceded_per_90,
                ...
                corners_and_indirect_freekicks_order: footballer.corners_and_indirect_freekicks_order,
                corners_and_indirect_freekicks_text: footballer.corners_and_indirect_freekicks_text,
        ...
        console.error("Couldn't populate the footballers table. Error:", error?.message);
    }
    finally {
