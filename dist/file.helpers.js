...
export const RAW_PLAYERS_SAMPLE_FILE = path.join(FILES_FOLDER, "raw_players_sample.json");
export const RAW_PLAYERS_ALL_FILE = path.join(FILES_FOLDER, "raw_players_all.json");
export const CLEANED_DATA_FILE = path.join(FILES_FOLDER, "cleaned_players.csv");
export const RAW_BOOTSTRAP_STATIC_FILE = path.join(FILES_FOLDER, "raw_bootstrap_static.json");
export const RAW_FOOTBALLERS_FILE = path.join(FILES_FOLDER, "raw_footballers.json");
