    ...
    try {
        ...
        for (const [footballerId, footballer] of Object.entries(rawData)) {
            ...
            if (!existingFootballerIds.has(parsedFootballerId)) {
                console.warn(`Skipping history for footballer_id=${parsedFootballerId} (not found in DB)`);
                continue;
            }
        ...
        console.error("Couldn't populate the history table. Error:", error?.message);
    }
    finally {
