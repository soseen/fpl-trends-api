...
import { BLACKLIST_FILE, CLEANED_DATA_FILE, RAW_PLAYERS_SAMPLE_FILE, } from "./file.helpers";
export const processRawData = async () => {
    ...
    const rawData = JSON.parse(fs.readFileSync(RAW_PLAYERS_SAMPLE_FILE, "utf8"));
